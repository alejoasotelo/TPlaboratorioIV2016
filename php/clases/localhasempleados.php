...
class LocalHasEmpleados{
    ...
    public function exists()
    {
        ...
        $consulta = $objetoAccesoDato->retornarConsulta("SELECT count(*) FROM locales_has_empleados WHERE id_local = :id_local");
    ...
    {
        $sql = 'INSERT INTO locales_has_empleados (`id_local`, `id_usuario`) VALUES (:id_local, :id_usuario)';
    ...
    {
        $sql = 'UPDATE locales_has_empleados SET id_usuario = :id_usuario WHERE id_local = :id_local';
    ...
    public static function borrarPorIdLocal($id)
    {
        ...
        $sql = 'DELETE FROM locales_has_empleados WHERE id_local IN ('.implode(',', $id).')';
